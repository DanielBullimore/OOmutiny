...
//#########################
  {
    this.Parent = OO;
    this.Parent();// "OoPoint"; //required to overide the super class type property
    this.Initialise('OoPoint'); //indexes the object in rayOO[][] and sets this instances numId
  }
//##############
//# FUNCTIONS #
//##############
